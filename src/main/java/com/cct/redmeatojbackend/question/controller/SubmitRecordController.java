...
import static com.cct.redmeatojbackend.common.constant.RedisConstant.LIMITER_PREFIX;
...
public class SubmitRecordController {
    ...
    @ApiOperation("提交记录添加")
    @Login
    @Limit(keyPrefix = LIMITER_PREFIX + "/submitRecord/add", count = 1, interval = 1)
    ...
    @Login
    @Limit(keyPrefix = LIMITER_PREFIX + "/submitRecord/addMQ", count = 1, interval = 1)
